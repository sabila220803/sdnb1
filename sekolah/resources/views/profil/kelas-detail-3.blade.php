...
<div class="container py-5">
    ...
    <div class="ekstrakurikuler-header text-center mb-5">
        <div class="btn btn-primary btn-lg px-5 py-3 rounded-pill shadow-lg">
            <h1 class="m-0">Daftar Siswa Kelas III SDN Bandarharjo 01</h1>
        </div>
    </div>

    <!-- Student Count Info -->
    <div class="text-center mb-4">
        <h4>Jumlah Seluruh Siswa = 30 Siswa</h4>
        <h5>Jumlah Siswa Laki-laki = 15 Siswa</h5>
    </div>
    ...
    <div class="text-center mb-4">
        <h5>Jumlah Siswi Perempuan = 15 Siswi</h5>
    </div>
